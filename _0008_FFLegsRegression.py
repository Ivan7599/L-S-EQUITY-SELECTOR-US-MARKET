# -*- coding: utf-8 -*-
# Unified: _0008_FFLegsRegression.py + _0008_FFLegsRegression-add.py
# OLS vs FF5+Mom for Long & Short legs — ALL models at once
#
# Inputs (unchanged):
#   - ./FilteredRawData/BaseLong_Returns.parquet
#   - ./FilteredRawData/BaseShort_Returns.parquet
#   - ./FilteredRawData/LightGBMLong_Returns.parquet
#   - ./FilteredRawData/LightGBMShort_Returns.parquet
#   - ./FilteredRawData/RidgeLong_Returns.parquet
#   - ./FilteredRawData/RidgeShort_Returns.parquet
#   - ./FilteredRawData/LightGBMScoreLong_Returns.parquet
#   - ./FilteredRawData/LightGBMScoreShort_Returns.parquet
#   - ./FilteredRawData/RidgeScoreLong_Returns.parquet
#   - ./FilteredRawData/RidgeScoreShort_Returns.parquet
#   - ./RawDatabase/Factors5.csv
#   - ./RawDatabase/Momentum.csv
#
# Outputs (unchanged):
#   - ./BaseOLSFamaLong.csv, ./BaseOLSFamaShort.csv
#   - ./LightGBMOLSFamaLong.csv, ./LightGBMOLSFamaShort.csv
#   - ./RidgeOLSFamaLong.csv, ./RidgeOLSFamaShort.csv
#   - ./LightGBMScoreOLSFamaLong.csv, ./LightGBMScoreOLSFamaShort.csv
#   - ./RidgeScoreOLSFamaLong.csv, ./RidgeScoreOLSFamaShort.csv
...
MODEL_SPECS = [
    ...
    {
        "name": "LightGBMScore",
        "long_parq":  Path("./FilteredRawData/LightGBMScoreLong_Returns.parquet"),
        "short_parq": Path("./FilteredRawData/LightGBMScoreShort_Returns.parquet"),
        "out_long":   Path("./LightGBMScoreOLSFamaLong.csv"),
        "out_short":  Path("./LightGBMScoreOLSFamaShort.csv"),
    },
    {
        "name": "RidgeScore",
        "long_parq":  Path("./FilteredRawData/RidgeScoreLong_Returns.parquet"),
        "short_parq": Path("./FilteredRawData/RidgeScoreShort_Returns.parquet"),
        "out_long":   Path("./RidgeScoreOLSFamaLong.csv"),
        "out_short":  Path("./RidgeScoreOLSFamaShort.csv"),
    },
]
...
def read_ff5(path: Path) -> pl.DataFrame:
    # DATE,Mkt_RF,SMB,HML,RMW,CMA,RF (percent)
...
# ----------------- Main: read factors once, loop all models -----------------
def main():
